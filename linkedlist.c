...
int main() {
    ...
    while (still_continue) {
        ...
        scanf("%d", &item);
        printf("Enter 1 for inserting the value in the front, 2 for inserting the value in the end, 3 for inserting the value at the desired position, 4 for displaying the list, 5 for exiting: ");
        scanf("%d", &choice);
